...
echo
echo  " ____________________-=[Mr.Rizal404 Tools]=-____________________" | lolcat
echo  "|                                                           |" | lolcat
echo  "|              Root®Autor      : RizalCyber                  |" | lolcat
echo  "|              W.A             : +62 888-0548-0605       |" | lolcat
echo  "|              team            : Mr.RIZAL404        |" | lolcat
